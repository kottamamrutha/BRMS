...
public class Constant {
 		...
 		public static final String INSERT_QUERY="INSERT INTO `project_brms`.`trip_management`(`Trip_Id`,`Boarding_Time`,`Arrival_Time`,`Ticket_Charges`,`Bus_Reg_No`,`Route_Id`)  VALUES (?,?,?,?,?,?) ";
		...
		public static final String SELECT_ALL_QUERY="SELECT `Trip_Id`,`Boarding_Time`,`Arrival_Time`,`Ticket_Charges`,`Bus_Reg_No`,`Route_Id` FROM `project_brms`.`trip_management` ";
		private Constant() {}
