              ...
              <div class="book_room">
                ...
                <form class="book_now">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <span>Source</span>
                      <input class="online_book" placeholder="Enter a Source" type="text" />
                    </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <input class="online_book" placeholder="Enter  Arrival Time" type="time" />
                    </div>

                    <div class="col-md-12">
                      <span>Boarding Time</span>
                      <input class="online_book" placeholder="Enter  Boarding Time" type="time" />
                    </div>

                    <div class="col-md-12">
                      <span>Ticket Charges</span>
                      <input class="online_book" placeholder="Enter  TicketCharges" type="date" required />
                    </div>
                    <div class="col-md-12">
    ...
    <div class="about">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="about_img">
              <figure><img src="images/hillsbus (1).jpg" alt="#" /></figure>
            </div>
          </div>
        </div>
      </div>
