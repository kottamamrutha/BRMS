...
<body class="main-layout">
						...
						<nav class="navigation navbar navbar-expand-md navbar-dark">
							...
							<div class="collapse navbar-collapse" id="navbarsExample04">
								<ul class="navbar-nav mr-auto">
									...
									<li class="nav-link" id="dropdown" style="text-align: center;"
										size="3"><a href="trips.jsp"><span>Trips</span> <i
									...
									<!-- <li class="nav-item">
                          <a class="nav-link" href="index2.html">Trips</a>
                        </li> -->

									<li class="nav-item"><a class="nav-link"
										href="contact.jsp">Contact Us</a></li>

									<li class="nav-item"><a class="nav-link" href="login.jsp">Admin
											login</a></li>
								</ul>
							</div>
						</nav>
	...
	<main id="main">
		...
		<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Show All
			Trips Details</p>

	</main>
	<div>
		<div>
			<form method="get" action="ShowTrip" class="mx-1 mx-md-4">

				<input type="submit" value="show Trip"
