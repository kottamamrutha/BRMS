        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/pune1.jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>PUNE</h3>
                <p></p>
          ...
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/mumbai.jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>MUMBAI</h3>
              </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/JAIPUR.jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>JAIPUR</h3>
              </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/goa.jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>GOA</h3>
              </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/delhi (2).jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>DELHI</h3>
              </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div id="serv_hover" class="room">
              <div class="room_img">
                <figure><img src="images/punjab.jpg" alt="#" /></figure>
              </div>
              <div class="bed_room">
                <h3>AMRITSAR</h3>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul class="link_menu">
                ...
                <li class="active"><a href="room.jsp">Cities</a></li>
